...
//                        for (Map.Entry<String, Object> paths :pathsJson.entrySet()) {
//                            String url = "/"+basePath + paths.getKey();
//                            jsonObject1.put(url, paths.getValue());
//                        }
//                        jsonObject.put("paths", jsonObject1);
